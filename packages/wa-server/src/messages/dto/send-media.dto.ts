...
export class SendMediaDto {
  ...
  @ApiProperty({ description: 'Publicly accessible URL or base64 data URI of the media file', example: 'https://example.com/image.jpg' })
...
export class SendStickerDto {
  ...
  @ApiProperty({ description: 'Publicly accessible URL or base64 data URI of the sticker image (will be converted to WebP)', example: 'https://example.com/sticker.png' })
  @IsUrlOrDataUri() @MaxLength(10_485_760) url: string;
}
