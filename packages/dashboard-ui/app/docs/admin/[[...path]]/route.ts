...
const UPSTREAM = process.env.DASHBOARD_API_URL ?? "http://localhost:3000"
const SPEC_REWRITE_FROM = '"/api/docs-json"'
const SPEC_REWRITE_TO = '"/docs/admin/api/docs-json"'
...
export async function GET(
  ...
  // No path → serve the Scalar UI; any sub-path → forward as-is
